      ...
      {step === 2 && (
        <div className="space-y-5">
          ...
          >
            {chapters.length === 0 ? (
              ...
              chapters.map((chapter, index) => (
                <div
                  key={index}
                  className="text-gray-500 border border-gray-200 p-1 rounded-xl hover:border-gray hover:shadow-sm transition-all bg-white"
                >
                  <div className="flex items-start gap-3 mb-3">
                    <div className="flex items-center justify-center ml-2 w-6 h-6 rounded-full bg-violet-50 text-violet-600 text-xs font-semibold flex-shrink-0 mt-2">
                      {index + 1}
                    </div>
                    <input
                      type="text"
                    ...
                    <button
                      ...
                      className="opacity-100 group-hover:opacity-100 p-1.5 rounded-lg hover:bg-red-50 transition-all "
          ...
          <div className="flex items-center justify-between pt-4 border-t border-gray-100">
            <Button varient="" onClick={() => setStep(1)} icon={ArrowLeft}>
              Back
            </Button>
