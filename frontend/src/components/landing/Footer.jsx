...
const Footer = () => {
  return (
    <footer className="relative bg-gradient-to-br from-gray-950 via-gray-750 to-violet-950 text-white overflow-hidden ">
        ...
        <div className="py-16 grid grid-cols-1 md:grid-cols-12 gap-12">
          ...
          <div className="md:col-span-5 space-y-6">
            ...
            <p className="text-gray-400 leading-relaxed max-w-sm">
              Create, Design, and Publish stunnig ebooks with the power of AI.
            </p>
          </div>
        ...
        <div className="border-t border-white/10 py-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            <p className="text-gray-500 text-sm">
              Made with <span className="text-violet-500">LOVE</span>
            </p>
          </div>
        </div>
      </div>
