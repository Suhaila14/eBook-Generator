...
import HERO_IMG from "../../assets/landing_img.png";
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-24 lg:py-32 relative">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="max-w-xl space-y-8">
            <div className="inline-flex items-center space-x-2 bg-white/80 backdrop-blur-sm px-4 py-2 rounded-full  border border-violet-300 shadow-md">
            ...
            <h1 className="text-5xl sm:text-6xl lg:text-6xl font-bold text-gray-700 leading-tight tracking-tight ">
              Create Stunning
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
              <Link
                ...
                className="group inline-flex items-center space-x-2 bg-gradient-to-r from-violet-600 to-purple-600 text-white px-8 py-4 rounded-xl font-semibold shadow-lg shadow-violet-500/50 hover:shadow-violet-500/50 hover:scale-105 transition-all duration-200"
              >
          ...
          <div className="relative lg:pl-8">
            <div className="relative">
              ...
              <div className="relative bg-white rounded-xl shadow-xl overflow-hidden border border-gray-100">
                ...
                />
                <div className="flex absolute top-6 right-6 bg-white rounded-2xl shadow-xl p-4 backdrop-blur-sm border border-gray-100 animate-in fade-in slide-in-from-right duration-700">
            ...
            <div className=" flex absolute bottom-6 left-10 bg-white rounded-2xl shadow-xl px-5 py-3 backdrop-blur-sm border border-gray-100 animate-in fade-in slide-in-from-left duration-700 delay-300">
              <div className=" items-center space-x-3">
              ...
              <div className="flex flex-col gap-1 mx-4">
                <div className="text-xs pt-1 text-gray-500">Completed</div>
                <div className="text-sm font-semibold text-gray-900">
                  247 Pages
                </div>
              </div>
