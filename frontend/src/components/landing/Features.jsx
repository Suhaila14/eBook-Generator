      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative">
        <div className="text-center mb-20 space-y-4">
          <div className="inline-flex items-center space-x-2  bg-violet-100 px-4 py-2 rounded-full ">
            ...
            <span className="text-sm font-semi-bold text-violet-900">
              Features
            </span>
          </div>
            ...
            return (
              ...
              >
                ...
                <div className="relative space-y-4">
                  <div
                    className={`w-14 h-14 bg-gradient-to-br ${features.gradient} rounded-xl flex items-center justify-center shadow-lg shadow-${features.gradient}/20 group-hover:scale-110 transition-transform duration-300`}
                  >
