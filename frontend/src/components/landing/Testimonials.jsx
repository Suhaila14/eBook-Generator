...
const Testimonials = () => {
  return (
    <div
      id="testimonials"
      className="relative lg:py-32 bg-gradient-to-br from-violet-50 via-purple-50 to-white- overflow-hidden"
    >
      {/*Decorative Elements*/}
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {TESTIMONIALS.map((testimonial, index) => (
            <div key={index} className="group relative bg-white/80 backdrop-blur-sm rounded-3xl p-8 border border-gray-200 hover:border-violet-200 hover:shadow-2xl hover:shadow-violet-500/10 transition-all duration-300 hover:-translate-y-2">
              {/*Quote Icon*/}
              ...
              <div className="flex items-center space-x-1 mb-6">
                {/*ex:[...Array(5)] creates [undefined, undefined, undefined, undefined, undefined]
                .map((_, i) => ...), "_" = undefined & "i*" = 0, then 1 and then 2 and till 5.. that is index.
                Finally becomes testimonial.rating = 5*/}
              ...
              <div className="flex items-center space-x-4">
                <div className="relative">
                  ...
                  <img
                    className="relative w-14 h-14 rounded-full objetct-cover ring-2 ring-white shadow-lg"
              ...
              <div className="absolute inset-0 bg-gradient-to-br from-violet-50/0 group-hover:from-violet-50/50 group-hover:to-purple-50/30 rounded-3xl transition-all duration-300 -z-10"></div>
            </div>
          ))}
        </div>
        ...
        <div className="mt-20 grid grid-cols-1 sm:grid-cols-3 gap-8 max-w-4xl mx-auto">
          ...
          <div className="text-center">
            <div className="text-4xl font-bold text-gray-900 mb-2">4.75/5</div>
