...
const BookCardSkeleton = () => (
  <div className="animate-pulse bg-white border border-slate-200 rounded-t-lg shadow-sm">
    ...
    <DashboardLayout>
      <div className="container mx-auto p-6">
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-[13px text-slate-600 mt-1">
              Create, edit and manage all your AI_generated eBooks.
            </p>
          </div>
          <Button
        ...
        {isLoading ? (
          ...
          <div className="flex flex-col items-center justify-center py-12 text-center border border-dashed border-slate-300 rounded-xl mt--8">
